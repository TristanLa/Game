...
class Card:
    ...
    value_name = ["Deux", "Trois", "Quatre", "Cinq", "Six", "Sept", "Huit", "Neuf", "Dix", "Valet", "Dame", "Roi", "As"]
...
def Deal():
    ...
    for i in range(0, 13):
        ...
        deck.cards.pop(a)
    for i in range(0,5):
        d[p1][1].append(Player1[i])
        d[p2][1].append(Player2[i])
        d[p3][1].append(Player3[i])
        d[p4][1].append(Player4[i])
    for i in range(5,9):
        d[p1][2].append(Player1[i])
        d[p2][2].append(Player2[i])
        d[p3][2].append(Player3[i])
        d[p4][2].append(Player4[i])
    for i in range(9,13):
        d[p1][3].append(Player1[i])
        d[p2][3].append(Player2[i])
        d[p3][3].append(Player3[i])
        d[p4][3].append(Player4[i])
    return d
